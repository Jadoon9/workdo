...
const BrowseEvents = () => {
  ...
  return (
    <div className="paddingX">
      <div className="flex-between h-[600px]">
        <div className="">
          <h2 className="h1-bold">
            Browse <br /> categories
          </h2>
          <p className="body-regular w-[60%] my-5 capitalize">
          ...
          <div className="flex  mt-24 mb-4 w-1/2">
        ...
        <div>
          <img
            src={vertLogo}
            alt=""
            className="h-[600px] p-0 w-96 object-cover"
          />
        </div>
      </div>
